...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while (system) {
			System.out.println("Qual acao do Funcioanrio deseja executar: ");
			...
			System.out.println("4 - Pesquisa Funcionário salario");
	...
	private void buscaFuncionarioDataContratacao(Scanner scanner) {
		...
		List<Funcionario> list = funcionarioRepository.findDataContratacao(localDate);
		list.forEach(System.out::println);
	}
